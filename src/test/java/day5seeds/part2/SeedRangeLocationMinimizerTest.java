...
class SeedRangeLocationMinimizerTest {
    private final SeedRangeMapping testMapping = new SeedRangeMapping(
    ...
    @Test
    public void seedRangeLocationMinimizerFindsCorrectLocation() {
        long location = new SeedRangeLocationMinimizer().getLowestLocationForSeeds(testMapping);

        assertThat(location).isEqualTo(46L);
    }
}